...
| **POINTER** | hold bottom-left pinky | Mouse buttons, DPI, sniping, drag-scroll |
...
**Trackball:** auto-mouse is **off** (palm rests on the ball). Hold the bottom-left pinky for POINTER.
